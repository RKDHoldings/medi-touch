            ...
            <div class="col-12 col-xl-6">
              <form action="forms/contact.php" method="post" role="form" class="php-email-form border-0">
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control custom-border" id="name" placeholder="Your Name" required>
                </div>
                <div class=" form-group mt-3">
                  <label for="email" class="form-label fw-bold">Email</label>
                  <input type="email" class="form-control custom-border" name="email" id="email" placeholder="Your Email" required>
                </div>
                <div class="form-group mt-3">
                  <label for="subject" class="form-label fw-bold">Subject</label>
                  <input type="text" class="form-control custom-border" name="subject" id="subject" placeholder="Subject" required>
                </div>
                <div class="form-group mt-3">
                  <label for="message" class="form-label fw-bold">Message</label>
                  <textarea class="form-control custom-border" name="message" rows="5" placeholder="Message" required></textarea>
                </div>
                <div class="my-3">
            ...
            <div class="row gx-3">
              ...
              <div class="col-lg-3">
                <div class="info">
                  ...
                  <h4>Email:</h4>
                  <p class="mb-4">novainstitute.lp@gmail.com</p>
                </div>
              </div>
              <div class="col-lg-3">
                <div class="info">
